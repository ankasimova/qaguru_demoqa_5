...
def test_fill_in_form():
    ...
    # ASSERTIONS
    table = browser.all('table tr')
    table.element(1).should(have.text(user_full_name))
    table.element(2).should(have.text(user_data['email']))
    table.element(3).should(have.text(user_data['gender']))
    table.element(4).should(have.text(user_data['phone_number']))
    table.element(5).should(have.text(user_full_date_of_birth))
    table.element(6).should(have.text(user_subjects_string))
    table.element(7).should(have.text(user_hobbies))
    table.element(8).should(have.text(user_data['picture']['file_name']))
    table.element(9).should(have.text(user_data['address']['current']))
    table.element(10).should(have.text(user_full_address))
